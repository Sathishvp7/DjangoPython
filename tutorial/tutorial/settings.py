...
SECRET_KEY = '*j4u7+#k7(hzp&f6_+$r1)nqq5u1kalb2b$cy0tptj^^*lhvv-'
...
MIDDLEWARE_CLASSES = [
    ...
    #'django.middleware.currentuser.ThreadLocalUserMiddleware',
]
...
EMAIL_PORT = 1025
#AUTH_PROFILE_MODULE= 'userprofile.Blogs'